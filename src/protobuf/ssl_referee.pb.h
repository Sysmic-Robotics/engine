...
inline void SSL_Referee::_internal_set_source_identifier(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  source_identifier_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void SSL_Referee::set_source_identifier(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  source_identifier_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:SSL_Referee.source_identifier)
}
inline void SSL_Referee::set_source_identifier(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  source_identifier_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* SSL_Referee::_internal_mutable_source_identifier() {
  _has_bits_[0] |= 0x00000001u;
  return source_identifier_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
