...
#ifndef PROTOBUF_INCLUDED_ssl_5fgc_5frcon_2eproto
#define PROTOBUF_INCLUDED_ssl_5fgc_5frcon_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ssl_5fgc_5frcon_2eproto 
...
class ControllerReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ControllerReply) */ {
 ...
 private:
  ...
  int status_code_;
  int verification_;
  friend struct ::protobuf_ssl_5fgc_5frcon_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
#endif  // PROTOBUF_INCLUDED_ssl_5fgc_5frcon_2eproto
