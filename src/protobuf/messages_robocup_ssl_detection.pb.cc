...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 42, -1, -1, sizeof(::SSL_DetectionFrame)},
};
...
const char descriptor_table_protodef_messages_5frobocup_5fssl_5fdetection_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n$messages_robocup_ssl_detection.proto\"\221"
  "\001\n\021SSL_DetectionBall\022\022\n\nconfidence\030\001 \001(\002"
  "\022\021\n\004area\030\002 \001(\rH\000\210\001\001\022\t\n\001x\030\003 \001(\002\022\t\n\001y\030\004 \001("
  "\002\022\016\n\001z\030\005 \001(\002H\001\210\001\001\022\017\n\007pixel_x\030\006 \001(\002\022\017\n\007pi"
  "xel_y\030\007 \001(\002B\007\n\005_areaB\004\n\002_z\"\316\001\n\022SSL_Detec"
  "tionRobot\022\022\n\nconfidence\030\001 \001(\002\022\025\n\010robot_i"
  "d\030\002 \001(\rH\000\210\001\001\022\t\n\001x\030\003 \001(\002\022\t\n\001y\030\004 \001(\002\022\030\n\013or"
  "ientation\030\005 \001(\002H\001\210\001\001\022\017\n\007pixel_x\030\006 \001(\002\022\017\n"
  "\007pixel_y\030\007 \001(\002\022\023\n\006height\030\010 \001(\002H\002\210\001\001B\013\n\t_"
  "robot_idB\016\n\014_orientationB\t\n\007_height\"\331\001\n\022"
  "SSL_DetectionFrame\022\024\n\014frame_number\030\001 \001(\r"
  "\022\021\n\tt_capture\030\002 \001(\001\022\016\n\006t_sent\030\003 \001(\001\022\021\n\tc"
  "amera_id\030\004 \001(\r\022!\n\005balls\030\005 \003(\0132\022.SSL_Dete"
  "ctionBall\022*\n\rrobots_yellow\030\006 \003(\0132\023.SSL_D"
  "etectionRobot\022(\n\013robots_blue\030\007 \003(\0132\023.SSL"
  "_DetectionRobotb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_messages_5frobocup_5fssl_5fdetection_2eproto = {
    false, false, 623, descriptor_table_protodef_messages_5frobocup_5fssl_5fdetection_2eproto,
...
// @@protoc_insertion_point(message_clear_start:SSL_DetectionBall)
  ...
  _impl_.z_ = 0;
  ::memset(&_impl_.pixel_x_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.pixel_y_) -
      reinterpret_cast<char*>(&_impl_.pixel_x_)) + sizeof(_impl_.pixel_y_));
...
uint8_t* SSL_DetectionBall::_InternalSerialize(
  ...
  // float pixel_x = 6;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_pixel_x = this->_internal_pixel_x();
  uint32_t raw_pixel_x;
  memcpy(&raw_pixel_x, &tmp_pixel_x, sizeof(tmp_pixel_x));
  if (raw_pixel_x != 0) {
    target = stream->EnsureSpace(target);
  ...
  // float pixel_y = 7;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_pixel_y = this->_internal_pixel_y();
  uint32_t raw_pixel_y;
  memcpy(&raw_pixel_y, &tmp_pixel_y, sizeof(tmp_pixel_y));
  if (raw_pixel_y != 0) {
    target = stream->EnsureSpace(target);
...
void SSL_DetectionBall::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_pixel_x = from._internal_pixel_x();
  uint32_t raw_pixel_x;
  memcpy(&raw_pixel_x, &tmp_pixel_x, sizeof(tmp_pixel_x));
  if (raw_pixel_x != 0) {
    _this->_internal_set_pixel_x(from._internal_pixel_x());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_pixel_y = from._internal_pixel_y();
  uint32_t raw_pixel_y;
  memcpy(&raw_pixel_y, &tmp_pixel_y, sizeof(tmp_pixel_y));
  if (raw_pixel_y != 0) {
    _this->_internal_set_pixel_y(from._internal_pixel_y());
  }
...
uint8_t* SSL_DetectionFrame::_InternalSerialize(
  ...
  double tmp_t_capture = this->_internal_t_capture();
  uint64_t raw_t_capture;
  memcpy(&raw_t_capture, &tmp_t_capture, sizeof(tmp_t_capture));
  if (raw_t_capture != 0) {
    target = stream->EnsureSpace(target);
  ...
  // double t_sent = 3;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_t_sent = this->_internal_t_sent();
  uint64_t raw_t_sent;
  memcpy(&raw_t_sent, &tmp_t_sent, sizeof(tmp_t_sent));
  if (raw_t_sent != 0) {
    target = stream->EnsureSpace(target);
...
void SSL_DetectionFrame::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_t_capture = from._internal_t_capture();
  uint64_t raw_t_capture;
  memcpy(&raw_t_capture, &tmp_t_capture, sizeof(tmp_t_capture));
  if (raw_t_capture != 0) {
    _this->_internal_set_t_capture(from._internal_t_capture());
  }
  ...
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_t_sent = from._internal_t_sent();
  uint64_t raw_t_sent;
  memcpy(&raw_t_sent, &tmp_t_sent, sizeof(tmp_t_sent));
  if (raw_t_sent != 0) {
    _this->_internal_set_t_sent(from._internal_t_sent());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
