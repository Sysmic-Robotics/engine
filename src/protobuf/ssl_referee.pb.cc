...
void SSL_Referee_TeamInfo::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      ...
      0, static_cast<size_t>(reinterpret_cast<char*>(&ball_placement_failures_reached_) -
      reinterpret_cast<char*>(&score_)) + sizeof(ball_placement_failures_reached_));
}
...
SSL_Referee::SSL_Referee(const SSL_Referee& from)
  ...
  if (from._internal_has_source_identifier()) {
    source_identifier_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_source_identifier(), 
      GetArena());
  }
